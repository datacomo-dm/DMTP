...
int ha_initialize_handlerton(st_plugin_int *plugin)
{
  ...
  */
  ...
  /* THD structure was added a item 'dtmsg' to point a DT error message,
   in 5.1.23rc, we need not to concern alloc object of handler..
  */
	  /* i really need these codes? Supposed no. */
	  /*
      {
	  handler *rh=new ha_myisam(table);
	  THD *thd=current_thd;
	  if(thd->dtmsg[0]!=0) {
		delete rh;
		return NULL;
