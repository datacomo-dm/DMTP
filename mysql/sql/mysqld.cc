...
/* add declaration of wdbi8 and dt_svrlib
*/
#include "dt_svrlib.h"

/* Add dt oracle connections parameters
*/
bool killing_server=FALSE;
uint volatile dt_index_read=0;
char dp_cache_report[300];
uint volatile dp_cache_size=20;
my_bool dp_para_mode=0;
...
/* Modified by DT project--BEGIN--*/
/* add a line 
 Set DT's internal status variables
*/
  killing_server=TRUE;
/* Modified by DT project--END--*/
...
#endif
{
  ...
  */
  ...
  init_signals();
  /* Modified by DT project--BEGIN--*/
  /* Add woci initializing :
  */
  WOCIInit( DBPLUS_STR "_svr_trace");
  strcpy(dp_cache_report,"无效");
  dp_cache::initInstance(dp_cache_size*1024/512,512*1024);// dp_cache_size单位MB,块大小固定512KB
...
enum options_mysqld
{
  ...
  /* Modified by DT project--BEGIN--*/  
/* Add enum item of DT's parameters.
*/
  OPT_DP_PARA_MODE,
  OPT_DP_CACHE_SIZE
/* Modified by DT project--END--*/ 
...
The minimum value for this variable is 4096.",
  ...
  {"net_write_timeout", OPT_NET_WRITE_TIMEOUT,
   ...
   REQUIRED_ARG, NET_WRITE_TIMEOUT, 1, LONG_TIMEOUT, 0, 1, 0},
    /* Modified by DT project--BEGIN--*/  
  // add codes to declare DBPLUS varibales
    {"dp_para_mode", OPT_DP_PARA_MODE, "Switch " DBPLUS_STR " parallel mode on;Default value is off.",
   (uchar** ) &dp_para_mode, (uchar**) &dp_para_mode, 0, GET_BOOL, NO_ARG, 0, 0, 0,
   0, 0, 0},
  {"dp_cache_size", OPT_DP_CACHE_SIZE, "Set " DBPLUS_STR " Global cache size(MB);Default value is 40(MB).",
   (uchar**) &dp_cache_size, (uchar**) &dp_cache_size, 0, GET_UINT, REQUIRED_ARG, 40, 20, 2000,
   0, 0, 0},
  /* Modified by DT project--END--*/  
...
/* Modified by DT project--BEGIN--*/
/* Add statistics 'dt_index_read'
*/
  {"DP_index_read",	       (char*) &dt_index_read,          SHOW_INT},
  {"DP_CACHE",(char *)dp_cache_report,		SHOW_CHAR},
/* Modified by DT project--END--*/
