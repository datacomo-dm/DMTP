...
#include "sql_trigger.h"
  ...
  /* Add a line to refresh cache status :*/
...
mysql_execute_command(THD *thd)
{
  ...
  */
	  {
	  extern char dp_cache_report[]; 
	  dp_cache::getInstance()->RepStatus(dp_cache_report);
...
finish:
/* Modified by DT project--BEGIN--*/
  /* differ from mysql 4.0.24 !! */
  if(thd->dtmsg[0]!=0) {
	   thd->main_da.set_error_status(thd,ER_ERROR_MESSAGES,thd->dtmsg);
	   res=TRUE;
  }
  /* Modified by DT project--END--*/
