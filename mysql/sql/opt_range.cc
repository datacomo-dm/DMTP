...
extern "C" int truncate_subkey(enum ha_base_keytype type,char *keysrc,char *keydst,uint subkey_length) ;
  ...
  if (!keys_to_use.is_clear_all())
  {
    ...
    */
	...
	key_parts->null_bit=	 key_part_info->null_bit;
	  /* Modified by DT project--BEGIN--*/
	key_parts->wide_partlen = key_info->key_part[part].wide_partlen ;
  /* Modified by DT project--END--*/
            ...
            KEY_PART *key_part, Item_func::Functype type,Item *value)
{
  ...
  */
  ...
  field->get_key_image(str+maybe_null, key_part->length,
                       key_part->image_type);
  /* Modified by DT project--BEGIN--*/
  if(type!=Item_func::LT_FUNC) {
	     truncate_subkey(field->key_type(),(char *)str+1,(char *)str+1,key_part->wide_partlen);
  }
  /* Modified by DT project--END--*/
  ...
  */
  ...
  for (part=0 ; part < ref->key_parts ;part++,key_part++)
  {
    ...
    key_part->flag=         (uint8) key_info->key_part[part].key_part_flag;
	  /* Modified by DT project--BEGIN--*/
    key_part->wide_partlen=key_info->key_part[part].wide_partlen;
  /* Modified by DT project--END--*/
  }
  if (insert_dynamic(&quick->ranges,(uchar*)&range))
    goto err;
