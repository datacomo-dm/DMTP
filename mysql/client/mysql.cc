...
int main(int argc,char *argv[])
{
  ...
  put_info("Welcome to the DataMerger monitor.  Commands end with ; or \\g.",
	   INFO_INFO);
  sprintf((char*) glob_buffer.ptr(),
	  "Your DataMerger connection id is %lu\nServer version: %s\n",
...
#define printf	consoleprintf
  ...
  if (version)
    return;
  printf("\
Copyright 2000-2008 DataMerger,DataComo, Inc.\n\
