...
void set_result(Tcl_Interp *interp, unsigned int i);
...
void set_result(Tcl_Interp *interp, ODate const &o);
...
void set_result(Tcl_Interp *interp, const char *s);
...
public:
     ...
     explicit object(unsigned int i);
     explicit object(ODate i);
     ...
     object & assign(unsigned int i);
     object & assign(long long l);
     ...
     object & operator=(unsigned int i)                { return assign(i); }
     object & operator=(long long l)               { return assign(l); }
...
template <> unsigned int         object::get<unsigned int>(interpreter &i) const;
template <> ODate         object::get<ODate>(interpreter &i) const;
