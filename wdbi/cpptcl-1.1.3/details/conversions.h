...
template <>
struct tcl_cast<ODate>
{
     static ODate from(Tcl_Interp *, Tcl_Obj *);
};

template <>
struct tcl_cast<unsigned int>
{
     static unsigned int from(Tcl_Interp *, Tcl_Obj *);
};
