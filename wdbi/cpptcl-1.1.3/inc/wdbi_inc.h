...
#define wociGetTitle(memtab,str,len,colsnm)                                        _wdbiGetTitle(memtab,str,len,colsnm)                                      
...
#define wociGetTitle(memtab,str,len,colsnm)                                        (LOGWHERE,_wdbiGetTitle(memtab,str,len,colsnm)                                         )
...
DllExport  void _wdbiWaitStmt(int stmt,int tm);
DllExport  void _wdbiWaitMemtable(int memtab,int tm);
