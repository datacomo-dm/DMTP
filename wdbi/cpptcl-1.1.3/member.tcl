...
#附加字段，用于存放积分兑换项目
dbAddColumn [$usrtab id] integraldef string 100 0
#保留附加字段，在执行SQL的时候不清除已有的字段
$usrtab SetAutoClear false
$usrtab FetchSQL "select companyid,usrid,'brand' brand,mphonecode,usrname,0 haveemp,decode(cardtypeid,'03',1,'02',2,3) grade	,\
