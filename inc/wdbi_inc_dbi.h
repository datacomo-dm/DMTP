...
#define wdbiGetStmtColumnNum(stmt)                                                 _wdbiGetStmtColumnNum(stmt)
#define wdbiGetStmtColumnName(stmt,col,colname)                                    _wdbiGetStmtColumnName(stmt,col,colname)
#define wdbiGetStmtColumnType(stmt,col)                                            _wdbiGetStmtColumnType(stmt,col)
...
#define wdbiGetStmtColumnNum(stmt)                                                 (LOGWHERE,_wdbiGetStmtColumnNum(stmt)                                                  )
#define wdbiGetStmtColumnName(stmt,col,colname)                                    (LOGWHERE,_wdbiGetStmtColumnName(stmt,col,colname)                                     )
#define wdbiGetStmtColumnType(stmt,col)                                            (LOGWHERE,_wdbiGetStmtColumnType(stmt,col)                                             )
